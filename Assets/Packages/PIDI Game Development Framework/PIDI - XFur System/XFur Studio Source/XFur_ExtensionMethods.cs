//Parts of this script were inspired and adapted from Unity answers, specifically the GetSubmesh method, thanks to user Bunny83 for his excellent solution.
...
using System.Collections.Generic;
 ...
 public static class XFur_ExtensionMethods
 {
    ...
    #region GetSubmesh
     ...
     private class Vertices
     {
         ...
         List<Vector4> tUV4 = new List<Vector4>();
         ...
         public Vertices(Mesh aMesh)
         {
             ...
             aMesh.GetUVs(2,tUV3);
             aMesh.GetUVs(3,tUV4);
             uv1 = CreateList(tUV1.ToArray());
             uv2 = CreateList(tUV2.ToArray());
             uv3 = CreateList(tUV3.ToArray());
             uv4 = CreateList(tUV4.ToArray());
